...
class AlunoControllerTest {
    ...
    public void configurar() {
        ...
        Aluno aluno2 = new Aluno(2L, "Maria", "1995-02-02", "Feminino");
    ...
    public void deveCriarUmAluno() throws Exception {
            Aluno aluno = new Aluno(1L, "João", "1990-01-01", "Masculino");
   ...
   @Test
    public void deveListarTodosOsAlunos() throws Exception {
        ...
        alunos.add(new Aluno(1L, "João", "1990-01-01", "Masculino"));
        alunos.add(new Aluno(2L, "Maria", "1995-02-02", "Feminino"));
