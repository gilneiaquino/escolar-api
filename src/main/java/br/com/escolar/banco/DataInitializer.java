...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Aluno aluno1 = new Aluno("1L","Marcos", LocalDate.of(1998,05,11), "Masculino", Arrays.asList(enderecoAluno1), Arrays.asList(telefoneAluno1),"teste@teste1.com","01145461148");
        ...
        Aluno aluno2 = new Aluno("2L","Maria", LocalDate.of(1998,01,15), "Feminino",Arrays.asList( enderecoAluno2), Arrays.asList(telefoneAluno2),"teste@teste2.com","01145461448");
        ...
        Aluno aluno3 = new Aluno("3L","Pedro", LocalDate.of(2024,05,28), "Masculino",Arrays.asList( enderecoAluno3), Arrays.asList(telefoneAluno3),"teste@teste3.com","01145461177");
